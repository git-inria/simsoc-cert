...
extern uint32_t StatusRegister_to_uint32(StatusRegister*);
extern void set_StatusRegister(StatusRegister*, uint32_t);

inline void set_GE_32(StatusRegister *sr, uint8_t n) {sr->GE2 = n&1; sr->GE3 = n>>1;}
inline void set_GE_10(StatusRegister *sr, uint8_t n) {sr->GE0 = n&1; sr->GE1 = n>>1;}
