...
let lib gencoq b ps =
  ...
  in
    ...
    List.iter (bprintf b "%s\n")
      ...
      ; ""
      ; sprintf "Require Import Bitvec Util %sFunctions %sConfig %s %sState ZArith %sMessage." G.preamble_name G.preamble_name G.preamble_proc G.preamble_name G.preamble_name
