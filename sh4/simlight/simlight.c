...
static struct SLSH4_MMU *mmu_ptr = NULL;
...
void test_decode(struct SLSH4_Processor *proc, struct ElfFile *elf) {
...
void simulate(struct SLSH4_Processor *proc, struct ElfFile *elf) {
...
int main(int argc, const char *argv[]) {
  ...
  struct SLSH4_Processor proc;
  struct SLSH4_MMU mmu;
  init_MMU(&mmu, 4 /* memory start */, 0x400000 /* memory size */);
  mmu_ptr = &mmu;
