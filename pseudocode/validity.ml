...
let constraints =
  let cs = Hashtbl.create 148 in
    ...
    Hashtbl.add cs "SMLAD" [NotPC "d"; NotPC "m"; NotPC "s"];
    Hashtbl.add cs "SMLAL" [NotPC "dHi"; NotPC "dLo"; NotPC "m"; NotPC "s"; NotSame ("dHi", "dLo")];
    Hashtbl.add cs "SMLALxy" [NotPC "dHi"; NotPC "dLo"; NotPC "m"; NotPC "s"; NotSame ("dHi", "dLo")];
    Hashtbl.add cs "SMLALD" [NotPC "dHi"; NotPC "dLo"; NotPC "m"; NotPC "s"; NotSame ("dHi", "dLo")];
    Hashtbl.add cs "SMLAWy" [NotPC "d"; NotPC "m"; NotPC "s"; NotPC "n"];
    Hashtbl.add cs "SMLSD" [NotPC "d"; NotPC "m"; NotPC "s"; NotPC "n"];
    Hashtbl.add cs "SMLLSD" [NotPC "dHi"; NotPC "dLo"; NotPC "m"; NotPC "s"; NotSame ("dHi", "dLo")];
    ...
    Hashtbl.add cs "SMULL" [NotPC "dHi"; NotPC "dLo"; NotPC "m"; NotPC "s"; NotSame ("dHi", "dLo")];
    ...
    Hashtbl.add cs "STREX" [NotPC "d"; NotPC "n"; NotPC "m"; NotSame ("d", "n"); NotSame ("d", "m")];
    Hashtbl.add cs "STRH" [NoWritebackDest; NotPC "d"];
    Hashtbl.add cs "STRT" [NotSame ("d", "n")];
    Hashtbl.add cs "SWP" [NotPC "d"; NotPC "n"; NotPC "m"; NotSame ("n", "m"); NotSame ("n", "d")];
    Hashtbl.add cs "SWPB" [NotPC "d"; NotPC "n"; NotPC "m"; NotSame ("n", "m"); NotSame ("n", "d")];
    ...
    Hashtbl.add cs "UMAAL" [NotPC "dHi"; NotPC "dLo"; NotPC "m"; NotPC "s"; NotSame ("dHi", "dLo")];
    Hashtbl.add cs "UMLAL" [NotPC "dHi"; NotPC "dLo"; NotPC "m"; NotPC "s"; NotSame ("dHi", "dLo")];
    Hashtbl.add cs "UMULL" [NotPC "dHi"; NotPC "dLo"; NotPC "m"; NotPC "s"; NotSame ("dHi", "dLo")];
    ...
    cs;; (* 116 instructions in this table / 148 *)
...
(* generate an exp that check the constraints *)
